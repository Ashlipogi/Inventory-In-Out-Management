...
export default function ApplicationLogo({ systemSettings, ...props }: ApplicationLogoProps) {
    ...
    // Reset error state when systemSettings changes
    useEffect(() => {
        setImageError(false);
        setImageLoaded(false);
    }, [systemSettings?.system_image]);

    // If we have a custom system image and it hasn't failed to load, show it
    if (systemSettings?.system_image && !imageError) {
        return (
            <div
                style={{
            ...
            >
                <img
                    src={`/imgs/system_image/${systemSettings.system_image}`}
